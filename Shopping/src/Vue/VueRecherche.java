...
public class VueRecherche extends JPanel {
    ...
    public VueRecherche (Mywindow parent, String demande) {
        ...
        JLabel titre = new JLabel("Votre recherche :");
        ...
        JPanel content = createBiscuitsPanel(parent,demande);
    ...
    private JPanel createBiscuitsPanel(Mywindow parent, String demande) {
        this.parent = parent;
        // Conteneur principal
...
//       }
        ...
        ArrayList<Article> produits = daoArticle.rechercher(demande);
